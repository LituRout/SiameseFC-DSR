...
% -------------------------------------------------------------------------------------------------------------------
function save_crops(imdb_video,v_1,v_end)
root_original = 'C:\AI_ML\Matlab\DataSets\ILSVRC2015';
root_crops = 'C:\AI_ML\Matlab\siamese-fc-master\ILSVRC2015_crops';
rootDataDir_src = [root_original '\Data\VID\train\'];
rootDataDir_dest = [root_crops '\Data\VID\train\'];
